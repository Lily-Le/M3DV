...
class PathManager:
    ...
    def info(self):
        ...
        df = pd.read_csv('../input/train-data/train_val.csv')
        return df
    ...
    def test_nodule_path(self):
        return os.path.join('../input/train-data/','test')

    @property
    def test_info(self):
        import pandas as pd
        df2 = pd.read_csv(os.path.join('../input/train-data/', 'test_result.csv'))
        return df2
    
    @property
    def test_path(self):
        return os.path.join('../input/train-data/', 'test_result.csv')
